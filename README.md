...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o78yqlm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o78yqlm.containers.anotherwebservice.com/
...
```
git clone git@github.com:devandris/container-o78yqlm.git
cd container-o78yqlm
```
...
```
docker attach container-o78yqlm
```
